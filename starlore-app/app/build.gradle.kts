...
android {
    namespace = "com.starlore.app"
    compileSdk {
        version = release(37)
    }

    defaultConfig {
        applicationId = "com.starlore.app"
        minSdk = 31
        targetSdk = 37
        ...
        buildConfigField(
            "String",
            "UPDATE_MANIFEST_URL",
            "\"https://www.starlore.cn/minio/my-files/releases/android/latest.json\""
        )
...
base {
    archivesName.set(vCodeProvider.map { "starlore-alpha$it" })
}
