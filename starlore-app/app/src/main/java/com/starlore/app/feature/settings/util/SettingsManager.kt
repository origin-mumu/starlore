...
object SettingsManager {
    ...
    val isSuperGraphicUltraModernGirlState =
        mutableStateOf(mmkv.decodeBool(KEY_SUPER_GRAPHIC_ULTRA_MODERN_GIRL, true))
    ...
    var isLiquidGlass: Boolean
        get() = mmkv.decodeBool(KEY_LIQUID_GLASS, true)
        set(value) {
    ...
    var colorMode: Int
        get() = mmkv.decodeInt(KEY_COLOR_MODE, MODE_LIGHT)
        set(value) {
    ...
    var isSuperGraphicUltraModernGirlEnabled: Boolean
        get() = mmkv.decodeBool(KEY_SUPER_GRAPHIC_ULTRA_MODERN_GIRL, true)
        set(value) {
    ...
    private const val DEFAULT_BACKEND_BASE_URL = "https://www.starlore.cn/api"

    /** Changes whenever the active login changes, so account-scoped screens reload their data. */
    ...
    var userNickname: String
        get() = mmkv.decodeString(KEY_USER_NICKNAME, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_NICKNAME, value)
        }

    var userRole: String
        get() = mmkv.decodeString(KEY_USER_ROLE, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_ROLE, value)
        }

    var userAvatar: String
        get() = mmkv.decodeString(KEY_USER_AVATAR, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_AVATAR, value)
        }

    var userUsername: String
        get() = mmkv.decodeString(KEY_USER_USERNAME, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_USERNAME, value)
        }

    private const val KEY_USER_BIO = "user_bio"
    private const val KEY_USER_EMAIL = "user_email"
    private const val KEY_USER_LOCATION = "user_location"
    private const val KEY_USER_WEBSITE = "user_website"
    private const val KEY_USER_GITHUB = "user_github"

    var userBio: String
        get() = mmkv.decodeString(KEY_USER_BIO, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_BIO, value)
        }

    var userEmail: String
        get() = mmkv.decodeString(KEY_USER_EMAIL, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_EMAIL, value)
        }

    var userLocation: String
        get() = mmkv.decodeString(KEY_USER_LOCATION, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_LOCATION, value)
        }

    var userWebsite: String
        get() = mmkv.decodeString(KEY_USER_WEBSITE, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_WEBSITE, value)
        }

    var userGithub: String
        get() = mmkv.decodeString(KEY_USER_GITHUB, "") ?: ""
        set(value) {
            mmkv.encode(KEY_USER_GITHUB, value)
        }

    var backendBaseUrl: String
        get() = mmkv.decodeString(KEY_BACKEND_BASE_URL, DEFAULT_BACKEND_BASE_URL) ?: DEFAULT_BACKEND_BASE_URL
        set(value) {
            mmkv.encode(KEY_BACKEND_BASE_URL, value)
        }
