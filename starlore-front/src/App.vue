...
<template>
  <div
    class="app-container"
    :class="{ 'app-container--echobot': route.path === '/vr' || route.path === '/harness' }"
  >
    <!-- 全局背景装饰 - 模糊气泡 -->
    <BlurredBubbles />
    ...
    <div
      class="router-outlet"
      :class="{ 'router-outlet--echobot': route.path === '/vr' || route.path === '/harness' }"
    >
      <RouterView />
    </div>
    <footer
      ...
      class="site-footer"
      :class="{ 'site-footer--echobot': route.path === '/harness' }"
    >
