...
import ConfirmDialog from '@/companion-studio/components/ConfirmDialog.vue'
import CycleMenu from '@/companion-studio/components/CycleMenu.vue'
import NameDialog from '@/companion-studio/components/NameDialog.vue'
import TimelineTrack from '@/companion-studio/components/TimelineTrack.vue'
import ZoomSlider from '@/companion-studio/components/ZoomSlider.vue'
import {
  blocksWith,
  makeBlock,
  MAX_CYCLES,
...
import type { StateId } from '@/companion-studio/editor/cycles'
import { MAX_ZOOM, MIN_ZOOM, mmss } from '@/companion-studio/ui/timeline'
import { nomDeCycle, pluriel, t } from '@/companion-studio/i18n'
