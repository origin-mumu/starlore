...
import BlockPicker from '@/companion-studio/components/BlockPicker.vue'
...
import { BASE_SCALE, clampZoom, ticksFor } from '@/companion-studio/ui/timeline'
...
function label(index: number) {
  return stateName(props.blocks[index]!.state)
}
...
<template>
  <div class="relative flex-1">
    <div
      ref="track"
      class="sans-barre h-full overflow-x-auto overflow-y-hidden"
      @scroll="onScroll"
      @wheel="onWheel"
    >
