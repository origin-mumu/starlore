...
async def create_config(
    ...
    return SimpleResponse.ok("配置创建成功", {"id": config.id})


@router.put("/{config_id}", response_model=SimpleResponse)
async def update_config(
    ...
    await ai_config_service.update_config(db, config_id, req)
    return SimpleResponse.ok("配置更新成功")


@router.delete("/{config_id}", response_model=SimpleResponse)
async def delete_config(
    ...
    return SimpleResponse.ok("配置删除成功")
